# Create a private key for the account registration
...
#   email_address   = "davidakalugo@gmail.com"
# }

# # Generate a random password for the PFX format
...
#     command = <<EOT
#     sudo certbot certonly --standalone -d mydavidcloud.xyz
#     openssl pkcs12 -export -out mydavidcloud.pfx -inkey /etc/letsencrypt/live/mydavidcloud.xyz/privkey.pem -in /etc/letsencrypt/live/mydavidcloud.xyz/cert.pem -certfile /etc/letsencrypt/live/mydavidcloud.xyz/chain.pem
#     EOT
#   }
# }
